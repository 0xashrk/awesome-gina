...
- optional layout conventions should follow `skills/official/hub/workflows/SKILL.md`
...
- For workflow layout conventions, use `skills/official/hub/workflows/SKILL.md` as reference.
